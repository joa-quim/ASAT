...
function [ts,dn,a, elev,sthour,date]=ReadDART(DARTname)
...
a=a';
fclose(fid);
% Remove the Header (first two lines of input file) if it exists
%if iscellstr(a(1,1))==1
%a(1:2,:)=[];
%display('Input file header was removed')
%end
